...
echo ""
echo -e "[38;5;226mifconfig                               	[0m [90m# Show IP and interfaces[0m[0m"
echo -e "[38;5;226mss -tulnp                          	[0m [90m# Show open ports[0m[0m"
echo -e "[38;5;226msudo nmap -A <ip-address>                 [0m [90m# Show network usage[0m[0m"
echo -e "[38;5;226msudo nmap -p 1-65535 -T4 <ip-address>	[0m [90m# Scans ALL TCP ports on the given IP[0m[0m"
echo -e "[38;5;226msudo wireshark                     	[0m [90m# Live network monitoring GUI[0m[0m"
echo -e "[38;5;226msudo iftop -i <interface-id>               	[0m [90m# Realtime bandwidth usage[0m[0m"
echo -e "[38;5;226msudo tshark -i <interface-id>              	[0m [90m# Packet capture CLI[0m[0m"
echo -e "[38;5;226msudo tcpdump -i <interface-id>             [0m [90m# Lightweight packet capture[0m[0m"
...
echo -e "[38;5;226mping -c 4 <ip-address>                  	[0m [90m# Test network connectivity[0m[0m"
...
echo -e "[38;5;46msudo ufw allow 22/tcp              	[0m [90m# Allow SSH through UFW firewall[0m[0m"
...
echo ""
echo -e "[38;5;51mls -la                             	[0m [90m# List ALL files in the directory you're in[0m[0m"
